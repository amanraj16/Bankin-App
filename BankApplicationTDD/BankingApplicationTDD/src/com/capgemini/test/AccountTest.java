...
public void whenTheValidInfoIsPassedAccountShouldBeCredittedSuccessfully() throws InvalidAccountNumberException
{
	...
	assertEquals(account.getAmount()+1500,accountService.depositAmount(101,1500));
}
@Test(expected=com.capgemini.exceptions.InvalidAccountNumberException.class)
...
@Test
public void whenTheInitialAmountForCreatingAnAccountIsSufficient() throws InsufficientOpeningBalanceException
{
